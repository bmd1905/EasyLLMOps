...
```json
{
  "body": "Brief summary of improvements.",
...
```json
{
  "body": "Added context by specifying a theme and desired tone, and defined the desired outcome by specifying the poem's length. This helps guide the output towards a more specific and engaging result.",
...
```json
{
  "body": "Added context by specifying target audience and desired length, clarified the desired outcome by suggesting a specific blog post structure, and improved tone/style to be more engaging and action-oriented.",
